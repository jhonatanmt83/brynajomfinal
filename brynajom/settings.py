...
ALLOWED_HOSTS = ['www.brynajom.com.pe','brynajom.com.pe']
...
SECRET_KEY = '55s7e5xf!zv7)app5zi0=ai)y^=gd!ocj*@p(p#v0!*!@i^7cf'
...
ROOT_URLCONF = 'brynajom.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'brynajom.wsgi.application'
